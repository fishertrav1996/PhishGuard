...
SECRET_KEY = 'django-insecure-a(qry*oih-j^5dn6p6k#555d4y%=)v*7o0c49@a&ji==_aq23('
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'orgs.context_processors.user_organizations',
            ],
        },
    },
]
...
# To use Gmail: Enable 2FA and generate an App Password
# Then set these in environment variables or update directly
